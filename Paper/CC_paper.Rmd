...
\ts{solving the posterior distribution is the key. However, this posterior distribution is intractable. Should I comment/show how to approximate the posterior distribution?}
...
\ts{Should I introduce the concept of variational distribution? The posterior distribution is intractable for exact inference.}
