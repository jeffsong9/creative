...
```{r test1, out.width='.33\\linewidth', fig.width=3, fig.height=3, fig.cap='Ternary Plot', eval=T, fig.subcap=c('Raw Unicode', 'Unicode Deleted', 'Unicode Translated into English'),  fig.scap=NA}
fig_raw_tern
fig_no_tern
fig_trans_tern
```
