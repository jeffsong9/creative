...
Our interest is solving the posterior distirbution of the following equation.

$$p(\boldsymbol\theta, \textbf{z} | \textbf{w}, \alpha, \beta)= \frac{p(\theta, z, w | \alpha, \beta)}{p(w|\alpha, \beta)}$$
\ts{Should I introduct the concept of variational distribution? The posterior distirubtion is intractable for exact inference.}
