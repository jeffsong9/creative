...
\hh{flesh this out next. Start with mathematical definitions of the data.}
...
\item $\phi_k \sim Dir(\beta), k=1, \dots, K$
\item $\phi_{k,v}$ is the probability of word $v \in \big\{1, \dots, V \big\}$ in topic $k \in \big\{1, \dots, K \big\}$
\item $w$ is a word drawn from a Multinomial distribution with parameter Z and $\phi$, i.e., $w \sim Multi(z, \phi)$.
\end{enumerate}
